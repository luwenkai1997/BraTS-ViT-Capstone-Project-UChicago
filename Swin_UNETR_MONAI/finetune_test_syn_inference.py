...
# 1. Paths
TRAINING_OUTPUT_DIR = '/home/cc/swin_unetr_train/SwinUNETR_Output_Patch96_Finetune' # <--- MODIFY if different
TEST_FILES_LIST_PATH = os.path.join(TRAINING_OUTPUT_DIR, "test_set_patient_files_syn.json")
BEST_MODEL_PATH = os.path.join(TRAINING_OUTPUT_DIR, "best_metric_model_swinunetr.pth")
TEST_RESULTS_DIR = os.path.join(TRAINING_OUTPUT_DIR, "test_run_results_syn")
